    ...
    create<NotificationSettingsState>((set, get) => ({
        ...
        setPreference: async (key, value) => {
            const nextState = {
                ...
                nearbyAlertsEnabled: get().nearbyAlertsEnabled,
                nearbyAlertRadiusKm: get().nearbyAlertRadiusKm,
                nearbyAlertsUrgentOnly: get().nearbyAlertsUrgentOnly,
                nearbyAlertCategorySlugs: get().nearbyAlertCategorySlugs,
